...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://pawanmishra.github.io}{\uline{pawanmishra.com}} $|$ % row = 2, col = 1
  \href{https://www.linkedin.com/in/rkpawan/}{\uline{LinkedIn}} $|$ % row = 2, col = 1
  \href{https://github.com/jane-doe}{\uline{GitHub}} %$|$ % row = 2, col = 1
  \href{}{} & % row = 2, col = 1
  Email: \href{mailto:rk.pawan@gmail.com}{\uline{rk.pawan@gmail.com}} $|$ % row = 2, col = 2
  Mobile: 737-202-7676 \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
...
\resumeHeadingListStart{}
  ...
  {Optum}{Austin, Tx, USA}
    \resumeItemListStart{}
      \resumeItem{Leading OptumInsight's provider engineering data platform teams, building platform components to optimize client implementations.}
      \resumeItem{Managing a cloud account with a yearly cost over 1.5 million USD}
      \resumeItem{Acting as Solution Architect for OptumInsight's Azure based analytics offering called Enterprise Intelligence Platform(EIP)}
      ...
      \resumeItem{Prioritized cloud cost optimization, saving 1+ million annually}
  ...
  {Optum}{Austin, Tx, USA}
    \resumeItemListStart{}
      \resumeItem{Lead the platform foundation team and successfully migrated OADW data pipeline from Oracle to AWS.}
        \resumeItem{Designed and implemented multiple Spark based libraries(SDL, dfParser, data-etl, etc.) that acclerated the cloud migration}
        \resumeItem{Implemented JSQLParser based library for converting SQL schema from one dialect to another}
        \resumeItem{Implemented Spark based lighweight and highly efficient data importer library}
        ...
        \resumeItem{Optimized ETLs, reducing build time from days to hours}
  ...
  {Advisory Board Company}{Austin, Tx, USA}
    \resumeItemListStart{}
        ...
        \resumeItem{Implemented healthcare metrics like percentage readmission, cost \& charges as Spark based enrichments}
    \resumeItemListEnd{}
